...
const ICONS = {
  ...
  drone: `<svg class="card-icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="10" y="9" width="4" height="4" rx="1"/><line x1="10" y1="9" x2="5" y2="4"/><line x1="14" y1="9" x2="19" y2="4"/><line x1="10" y1="13" x2="5" y2="18"/><line x1="14" y1="13" x2="19" y2="18"/><circle cx="4" cy="3" r="2"/><circle cx="20" cy="3" r="2"/><circle cx="4" cy="19" r="2"/><circle cx="20" cy="19" r="2"/><path d="M9 20l-1 3M12 21v3M15 20l1 3"/></svg>`,
};
...
function populateContent() {
  ...
  const fSocial = $('#footerSocial');
  if (fSocial) {
    const socials = [];
    if (d.empresa.instagram) socials.push({
      href: d.empresa.instagram,
      label: 'Instagram',
    ...
    if (d.empresa.facebook) socials.push({
      href: d.empresa.facebook,
      label: 'Facebook',
      icon: `<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>`,
    });
    if (d.empresa.tiktok) socials.push({
      href: d.empresa.tiktok,
      label: 'TikTok',
      icon: `<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20" aria-hidden="true"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.76a4.85 4.85 0 01-1.01-.07z"/></svg>`,
    });
    fSocial.innerHTML = socials.map(s =>
      `<a href="${s.href}" class="footer-social-link" target="_blank" rel="noopener noreferrer" aria-label="${s.label}">${s.icon}</a>`
    ).join('');
  }
}
